...
<html>
  ...
  <body> 
    <!-- Top Title -->
    <div class="jumbotron jumbotron-fluid text-center" style="background-color:#A70E16 !important;">
      <div class="container">
        <h1><?php echo "Amalgam";?></h1>
        <p>Kaustuv's EOS web-page for sharing plots and archiving work</p>
        <p>Contact: kadatta_AT_cern.ch,kdatta_AT_ethz.ch</p>
      </div>
